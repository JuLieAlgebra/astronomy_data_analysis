...
def generate_features_targets(data: np.array) -> Tuple(np.ndarray, np.array):
    """
    Parameters
    ----------
...
def predict(data: np.ndarray, n_estimators: int, kfold: int = 10) -> np.array:
    """
